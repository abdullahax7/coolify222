...
export default function FormRHW18({ data }: FormRHW18Props) {
  return (
    <div className="wales-form-html" style={{ 
      ...
      <div className="form-id">FORM RHW18</div>
      <div className="form-title">
        LANDLORD'S NOTICE OF TERMINATION: INTRODUCTORY STANDARD<br/>
        CONTRACT OR PROHIBITED CONDUCT STANDARD CONTRACT
      </div>
      <div className="form-subtitle">
        This form is for use by a landlord to give notice to a contract-holder of an introductory standard<br/>
        contract or prohibited conduct standard contract under section 173(1) of the Renting Homes (Wales) Act<br/>
        2016 that he or she must give up possession of the dwelling on a specified date.
      </div>
      ...
      <div className="part-single">
        ...
        <div className="part-d-body">
          <p>You, the contract-holder(s), under section 202(2) of to the Renting Homes (Wales) Act 2016, may request that the landlord reviews the decision to give this notice. A request for a review must be made to the landlord by [<em>date</em>] <span className="field-input-val" style={{ display: 'inline-block', width: '150pt', textAlign: 'center' }}>{data.reviewDate}</span></p>
          <p style={{ fontStyle: 'italic', marginTop: '8pt', fontSize: '10pt' }}>Note: The specified date must be at least 14 days after the day on which the landlord gives the contract-holder(s) this notice.</p>
        </div>
      </div>
      ...
      <div className="guidance-section">
        ...
        <div className="section-title" style={{ marginTop: '15pt' }}>Minimum notice period</div>
        <p>A prohibited conduct standard contract has a minimum notice period of two months. An introductory standard contract has a minimum notice period of six months, unless it falls within certain exceptions where the minimum notice period is two months.</p>
      </div>
    </div>
  );
}
