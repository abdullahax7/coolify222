...
export default function FormRHW21({ data }: FormRHW21Props) {
  return (
    <div className="wales-form-html" style={{ 
      ...
      <div className="form-id">FORM RHW21</div>
      <div className="form-title">
        LANDLORD'S NOTICE OF POSSESSION CLAIM ON THE GROUND OF<br/>
        SERIOUS RENT ARREARS: INTRODUCTORY STANDARD CONTRACT OR<br/>
      ...
      <div className="form-subtitle">
        ...
        contract or a prohibited conduct standard contract under section 182(1) of the Renting Homes<br/>
        (Wales) Act 2016 that the landlord intends to make a possession claim to the court on the ground of<br/>
