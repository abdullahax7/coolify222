...
export default function FormRHW22({ data }: FormRHW22Props) {
  return (
    <div className="wales-form-html" style={{ 
      ...
      <div className="form-id">FORM RHW22</div>
      <div className="form-title">
        LANDLORD'S NOTICE OF TERMINATION: FIXED TERM STANDARD<br/>
        CONTRACT WITHIN SCHEDULE 9B TO THE RENTING HOMES (WALES)<br/>
        ACT 2016
      </div>
      <div className="form-subtitle">
        This form is for use by a landlord to give notice to a contract-holder of a fixed term standard contract<br/>
        which is within Schedule 9B to the Renting Homes (Wales) Act 2016, under section 186(1) of that Act<br/>
        that he or she must give up possession of the dwelling on a specified date.
      </div>
      ...
      <div className="part-single">
        ...
        <div className="part-d-body">
          ...
          <p style={{ fontStyle: 'italic', marginTop: '8pt', fontSize: '10pt' }}>Note: The specified date must not be before the last day of the term for which the occupation contract was made, or less than two months after the day on which this notice is given to the contract-holder(s).</p>
        </div>
      </div>
