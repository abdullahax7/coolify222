...
export default function FormRHW4({ data }: FormRHW4Props) {
  return (
    <div className="wales-form-html" style={{ 
      ...
      <div className="form-id">FORM RHW4</div>
      <div className="form-title">NOTICE OF CHANGE IN LANDLORD'S ADDRESS</div>
      <div className="form-subtitle">
        This form is for use by a landlord to give notice to a contract-holder under section 39(3) of the Renting<br/>
        Homes (Wales) Act 2016 of a change in address to which documents intended for the landlord may be sent.
      </div>
      ...
      <div className="part-single">
        <div className="part-header">Part D: Notice of Change in Landlord's Address</div>
        <div className="part-d-body">
          <div style={{ marginBottom: '10pt' }}>There has been a change in the landlord's address.</div>
          <div className="field-row"><strong>New Address:</strong> <span className="field-input-val" style={{ whiteSpace: 'pre-wrap' }}>{data.newAddress}</span></div>
