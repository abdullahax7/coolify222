...
export default function FormRHW25({ data }: FormRHW25Props) {
  return (
    <div className="wales-form-html" style={{ 
      ...
      <div className="form-id">FORM RHW25</div>
      <div className="form-title">
        NOTICE OF TERMINATION UNDER LANDLORD'S BREAK CLAUSE: FIXED<br/>
        TERM STANDARD CONTRACT WITH TWO-MONTH MINIMUM NOTICE<br/>
        PERIOD
      </div>
      <div className="form-subtitle">
        This form is for use by a landlord to give notice to a contract-holder of a fixed term standard contract<br/>
        entitled to a two-month minimum notice period, in accordance with the landlord's break clause and<br/>
      ...
      <div className="part-single">
        ...
        <div className="part-d-body">
          ...
          <p style={{ fontStyle: 'italic', marginTop: '8pt', fontSize: '10pt' }}>Note: The specified date must not be less than two months after the day on which notice is given to the contract-holder(s) in accordance with the landlord's break clause.</p>
        </div>
      </div>
