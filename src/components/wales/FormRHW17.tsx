...
export default function FormRHW17({ data }: FormRHW17Props) {
  return (
    <div className="wales-form-html" style={{ 
      ...
      <div className="form-id">FORM RHW17</div>
      <div className="form-title">
        LANDLORD'S NOTICE OF TERMINATION: PERIODIC STANDARD<br/>
        CONTRACT WITH TWO-MONTH MINIMUM NOTICE PERIOD (OTHER THAN<br/>
        INTRODUCTORY STANDARD CONTRACT OR PROHIBITED CONDUCT<br/>
        STANDARD CONTRACT)
      </div>
      <div className="form-subtitle">
        This form is for use by a landlord to give notice to a periodic standard contract-holder entitled to a two-month<br/>
      ...
      <div className="part-single">
        ...
        <div className="part-d-body">
          ...
          <p style={{ fontStyle: 'italic', marginTop: '8pt', fontSize: '10pt' }}>Note: The specified date must not be less than two months after the day on which this notice is given to the contract-holder(s).</p>
        </div>
      </div>
      ...
      <div className="guidance-section">
        ...
        <div className="section-title" style={{ marginTop: '15pt' }}>Two-month minimum notice period</div>
        <p>An occupation contract may have a two-month minimum notice period because the occupation contract falls within Schedule 8A to the Renting Homes (Wales) Act (section 174A of that Act). This includes supported accommodation, student accommodation, and accommodation for homeless persons.</p>
        
        <div className="section-title" style={{ marginTop: '15pt' }}>Restrictions on giving this notice</div>
        <p>In accordance with section 175 of the Renting Homes (Wales) Act 2016, this notice may not be given within the first six months of the occupation date of the contract, unless it falls within certain exceptions in Schedule 9.</p>
      </div>
    </div>
  );
}
